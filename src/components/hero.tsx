import HeroButton from "./ui/get-started-btn";

export default function HeroSection() {
  return (
    <>
      <main>
        <section className="relative bg-background dark:bg-background pt-32 lg:pt-24 pb-32 lg:pb-24">
